...
void open_close() {
  ...
  for(int i=0; i< num_pins/2-1; i++) {
    digitalWrite(ledPins[i], HIGH);
    digitalWrite(ledPins[num_pins-i-1], HIGH);
    delay(delayTime);
  }
  
  for(int i=0; i< num_pins/2-1; i++) {
    digitalWrite(ledPins[i], LOW);
    digitalWrite(ledPins[num_pins-i-1], LOW);
    delay(delayTime);
  }

  
  for(int i= num_pins/2-1; i>=0; i--) {
    digitalWrite(ledPins[i], HIGH);
    digitalWrite(ledPins[num_pins-i-1], HIGH);
    delay(delayTime);
  }
...
void flash_led(int pin, int input_delay) {
  int delayTime = input_delay/10;
...
void ping_incep() {
  ...
  for(int i=0; i< num_pins/2-1; i++) {
    flash_led(ledPins[i], delayTime);
    flash_led(ledPins[num_pins-i-1], delayTime);
    delay(delayTime);
    digitalWrite(ledPins[i], LOW);
    digitalWrite(ledPins[num_pins-i-1], LOW);
    delay(delayTime);
